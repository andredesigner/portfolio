...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "container-fluid" }, _attrs))}><div class="row"><div class="offset-lg-2 col-lg-8"><div class="hero"><h1 class="title in-top-bottom">Designer de produtos digitais com experiência em criação de marca e desenvolvimento.</h1></div></div></div><div class="row"><nav class="offset-lg-2 col-lg-8"><p class="mb-3">Menu</p><ul class="ao-nav"><!--[-->`);
...
//# sourceMappingURL=index-B8pQZCwe.js.map
