  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.$route.name == "index") {
        _push(`<div class="container-fluid" data-v-9a9a8ec4><div class="row" data-v-9a9a8ec4><div class="offset-2 col offset-lg-2 col-lg-7" data-v-9a9a8ec4><p class="first-element-page" data-v-9a9a8ec4> Olá, <br data-v-9a9a8ec4> seja bem vindo. </p></div></div></div>`);
      } else {
...
//# sourceMappingURL=AoHeader-DX5GNSHE.js.map
